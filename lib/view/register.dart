                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (Password_input_confirm == Password_input &&
                              ...
                              try {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content:
                                          Text('กำลังสมัครสมาชิกสำหรับ User'),
                                      duration: Duration(seconds: 1)),
                                );
                            ...
                            if (Register_menu_state == false ||
                              ...
                              try {
                                ...
                                User_token = Storage_data().Token_Getting();
                                Navigator.pushNamed(context, '/second');
...
.then((value) => setState(() => {
              ...
              ElevatedButton(
                  onPressed: () {
                    //  Storage_data().Token_Saving("NoToken");
                    //  print(Storage_data().Token_Getting());
                    Navigator.pushNamed(context, '/second');
                  },
                  child: Text("Profile"))
